							...
							<div class="row main-row">
								<div class="12u">
									<section>
										...
										<?php }?>
										<header>
											<h2><?=sprintf(litMenuRetosAcciones)?> <input class="button" id="saveForm" name="saveForm" type="button" onclick="window.location.href='/acciones-nuevo-grupo.php'" value="<?=sprintf(litMenuNuevoRetoOtros)?>"></h2>
													...
													?>
														    ...
														    <tr class="ocultoFila" id="linea_<?=$objGrupo->getGruIdgrupo()?>">
														    	<td colspan="5">
																	...
																	<button class="botonTabla" onClick="window.location.href='/acciones-mis-grupos-estadisticas.php?idGrupo=<?=$objGrupo->getGruIdgrupo()?>';">
